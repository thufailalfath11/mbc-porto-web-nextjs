            ...
            >
              ...
              <div className={styles.txtcontainer}>
                <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
                  ...
                  <p
                    className={`${styles.desk} ${styles.paragraphMargin}`}
                    data-aos="fade-up"
                  >
                    Di sini, Anda akan menemukan berbagai proyek yang telah kami
                    kerjakan dengan penuh dedikasi dan semangat. kami senang
                    berbagi perjalanan kreatif dan pencapaian kami dalam
                    mengatasi tantangan yang telah kami hadapi. Mari kita
                    menjelajahi portfolio ini bersama dan lihat bagaimana kami
                    telah mewujudkan ide-ide dalam hasil Tugas besar kami.
                  </p>
                </div>
              </div>
            </div>
              ...
              >
                <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
                  ...
                  >
                    ...
                    disiplin, kreativitas, dan tekad kami dalam mencapai
                    prestasi luar biasa. Kami berharap karya-karya kami
                    menginspirasi dan menunjukkan potensi yang kami tawarkan
                    melalui kerjasama tim kami. Terima kasih telah mengunjungi
                    halaman kami dan selamat menikmati eksplorasi kami dalam
                    dunia riset dan inovasi di MBCLab.
                  </p>
                </div>
